...
public class OrbitalRailgunSounds {
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> RAILGUN_SHOOT = SOUNDS.register("railgun_shoot",
            () -> SoundEvent.createFixedRangeEvent(Identifier.fromNamespaceAndPath(OrbitalRailgun.MOD_ID, "railgun_shoot"), 500.0f));

    private static DeferredHolder<SoundEvent, SoundEvent> register(String name) {
        return SOUNDS.register(name, () -> SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(OrbitalRailgun.MOD_ID, name)));
    }
}
